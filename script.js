...
// Forloop putting data onto HMTL page
...
searchButton.click(function () {
  ...
  if (searchInput == "") {
    ...
    $.ajax({
      ...
      // Adding the  Temp to the card
      var currentTemp = currentName.append("<p>");
      // .addClass("card-text");
      currentName.append(currentTemp);
      currentTemp.append("<p>" + "Temperature: " + response.main.temp + "</p>");
      // adding the humidity to the card
      currentTemp.append(
        "<p>" + "Humidity: " + response.main.humidity + "%" + "</p>"
      );
      // // Adding the Wind Speed to the card:
      currentTemp.append("<p>" + "Wind Speed: " + response.wind.speed + "</p>");

      // the UV Index URL api
    ...
    // initailing the call for 5-day forecast
    $.ajax({
      url: urlFiveDay,
      method: "GET",
    }).then(function (response) {
